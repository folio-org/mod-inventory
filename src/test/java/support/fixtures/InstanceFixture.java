    ...
    return new JsonObject()
      ...
      .put("contributors", new JsonArray()
        .add(JsonObject.mapFrom(
          new Contributor("test name type id", "test name", "test type id", "test text", "test authority id", true))))
      .put("publication", new JsonArray()
        .add(
          JsonObject.mapFrom(new Publication("test publisher", "test place", LocalDate.now().toString(), "test role"))))
      ...
      .put("electronicAccess", new JsonArray()
        .add(JsonObject.mapFrom(
          new ElectronicAccess("test uri", "test link text", "test materials specification", "test public note",
