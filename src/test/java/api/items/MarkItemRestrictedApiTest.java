...
public class MarkItemRestrictedApiTest extends AbstractMarkItemApiTest {

  @Test
  void testMarkItemRestrictedPreservesCirculationNotes() {
  ...
  protected Response markItem(UUID id) {
    return markItemFixture.markRestricted(id);
  }
