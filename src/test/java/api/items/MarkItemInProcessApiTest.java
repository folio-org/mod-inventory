...
public class MarkItemInProcessApiTest extends AbstractMarkItemApiTest {

  @Test
  void testMarkItemInProcessCirculationNotes() {
  ...
  protected Response markItem(UUID id) {
    return markItemFixture.markInProcess(id);
  }
