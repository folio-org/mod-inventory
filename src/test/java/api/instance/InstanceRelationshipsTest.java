...
public class InstanceRelationshipsTest extends ApiTests {
  ...
  @AfterEach
  void disableFailureEmulationAndClearConsortia() throws Exception {
  ...
  @Test
  void canFetchMultipleInstancesWithRelationships() throws Exception {
  ...
  @Test
  void canFetchOneInstancesWith11Children() {
  ...
  @Test
  void canForwardInstanceRelationshipsFetchFailure() throws Exception {
  ...
  @Test
  void canFetchMultipleInstancesWithPrecedingSucceedingTitles() throws Exception {
    final int expectedCount = 200;
  ...
  @Test
  void canForwardInstancePrecedingSucceedingTitlesFetchFailure() throws Exception {
    final int expectedCount = 4;
  ...
  @Test
  void canFetchMultipleInstancesWithAllRelationshipsTypes() throws Exception {
    final int expectedCount = 200;
  ...
  @Test
  @SneakyThrows
  void cannotCreateAnInstanceWithNonExistedPrecedingTitleId() {
  ...
  @Test
  @SneakyThrows
  void cannotCreateAnInstanceWithNonExistedSucceedingTitleId() {
  ...
  @Test
  @SneakyThrows
  void cannotCreateAnInstanceWithNonExistedParentInstanceId() {
  ...
  @Test
  @SneakyThrows
  void cannotCreateAnInstanceWithNonExistedChildInstanceId() {
  ...
  @Test
  @SneakyThrows
  void cannotCreateAnInstanceWithNonExistedRelationshipType() {
  ...
  @Test
  @SneakyThrows
  void canForwardInstancePrecedingSucceedingTitlesUpdateFailure() {
  ...
  @Test
  @SneakyThrows
  void canForwardInstancePrecedingSucceedingTitlesDeleteFailure() {
    UUID nodId = UUID.randomUUID();
  ...
  @Test
  @SneakyThrows
  void canForwardInstanceRelationshipUpdateFailure() {
    UUID nodId = UUID.randomUUID();
  ...
  @Test
  @SneakyThrows
  void canForwardInstanceRelationshipDeleteFailure() {
    UUID nodId = UUID.randomUUID();
    String boundWithInstanceRelationshipTypeId = instanceRelationshipTypeFixture.boundWith().getId();
  ...
  @Test
  void parentChildInstancesReturnedWhenFetchSingleInstance() {
  ...
  @Test
  void canUpdateInstanceWithChildInstancesWhenParentInstancesAlreadySet() throws Exception {
    final IndividualResource parentInstance = instancesClient.create(nod(UUID.randomUUID()));
    final IndividualResource childInstance = instancesClient.create(nod(UUID.randomUUID()));
  ...
  @Test
  void cannotLinkLocalInstanceToSharedInstance()
  ...
  @Test
  void canCreateInstanceWithParentInstancesWhenConsortiaEnabled() {
    createConsortiumTenant();
  ...
  private Map<String, String> createPrecedingSucceedingTitlesAndRelationshipsInstances(int count) {
    final Map<String, String> precedingSucceedingInstances = createPrecedingSucceedingInstances(count);
