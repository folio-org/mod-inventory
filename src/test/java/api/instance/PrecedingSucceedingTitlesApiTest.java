...
public class PrecedingSucceedingTitlesApiTest extends ApiTests {
  ...
  @Test
  @SneakyThrows
  void canCreateAnInstanceWithUnconnectedPrecedingTitles() {
  ...
  @Test
  @SneakyThrows
  void canCreateAnInstanceWithUnconnectedSucceedingTitles() {
    String precedingSucceedingTitleId1 = UUID.randomUUID().toString();
    String precedingSucceedingTitleId2 = UUID.randomUUID().toString();
  ...
  @Test
  @SneakyThrows
  void canUpdateAnInstanceWithUnconnectedPrecedingTitles() {
  ...
  @Test
  @SneakyThrows
  void canUpdateAnInstanceWithUnconnectedSucceedingTitles() {
  ...
  @Test
  @SneakyThrows
  void titleIsRequiredToCreateAnInstanceWithUnconnectedSucceedingTitle() {
  ...
  @Test
  @SneakyThrows
  void titleIsRequiredToUpdateAnInstanceWithUnconnectedSucceedingTitle() {
    final JsonObject succeedingTitle = createSemanticWebUnconnectedTitle(UUID.randomUUID().toString());
    final JsonObject smallAngryPlanetJson = smallAngryPlanet(UUID.randomUUID())
      .put(SUCCEEDING_TITLES_KEY, new JsonArray()
        .add(succeedingTitle));
  ...
  @Test
  @SneakyThrows
  void titleIsRequiredToCreateAnInstanceWithUnconnectedPrecedingTitles() {
  ...
  @Test
  @SneakyThrows
  void titleIsRequiredToUpdateAnInstanceWithUnconnectedPrecedingTitles() {
    final JsonObject precedingTitle = createSemanticWebUnconnectedTitle(UUID.randomUUID().toString());
    final JsonObject smallAngryPlanetJson = smallAngryPlanet(UUID.randomUUID())
  ...
  @Test
  @SneakyThrows
  void titleIsRequiredToCreateInstancesUsingBatch() {
  ...
  @Test
  @SneakyThrows
  void canDeleteUnconnectedPrecedingTitle() {
    JsonObject precedingTitle = createSemanticWebUnconnectedTitle(UUID.randomUUID().toString());
    JsonObject smallAngryPlanetJson = smallAngryPlanet(UUID.randomUUID());
    smallAngryPlanetJson.put("precedingTitles", new JsonArray().add(precedingTitle));
  ...
  @Test
  @SneakyThrows
  void canDeleteUnconnectedSucceedingTitle() {
  ...
  void canCreateAnInstanceWithConnectedSucceedingTitles() {
    ...
    JsonObject uprootedSucceedingTitle =
      createConnectedSucceedingTitle(uprootedPrecedingTitleId, uprootedId.toString());
  ...
  @Test
  @SneakyThrows
  void canUpdateAnInstanceWithConnectedPrecedingTitles() {
    UUID nodId = UUID.randomUUID();
    UUID uprootedId = UUID.randomUUID();
    String nodPrecedingTitleId = UUID.randomUUID().toString();
    String uprootedPrecedingTitleId = UUID.randomUUID().toString();
    instancesClient.create(nod(nodId));
    instancesClient.create(uprooted(uprootedId));
  ...
  @Test
  @SneakyThrows
  void canUpdateAnInstanceWithConnectedSucceedingTitles() {
    UUID nodId = UUID.randomUUID();
    UUID uprootedId = UUID.randomUUID();
    String nodPrecedingTitleId = UUID.randomUUID().toString();
    String uprootedPrecedingTitleId = UUID.randomUUID().toString();
  ...
  @Test
  @SneakyThrows
  void canUpdateAnInstanceWithConnectedSucceedingTitleIfPrecedingAlreadySet() {
  ...
  void canCreateAnInstanceWithConnectedSucceedingAndPrecedingTitles() {
    ...
    JsonObject nodPrecedingTitle = createConnectedPrecedingTitle(nodPrecedingTitleId, nodId.toString());
    JsonObject uprootedSucceedingTitle =
      createConnectedSucceedingTitle(uprootedSucceedingTitleId, uprootedId.toString());
  ...
  @Test
  @SneakyThrows
  void canCreateBatchOfInstancesWithPrecedingSucceedingTitles() {
    String precedingSucceedingTitleId1 = UUID.randomUUID().toString();
    String precedingSucceedingTitleId2 = UUID.randomUUID().toString();
    JsonArray precedingTitles = getUnconnectedPrecedingSucceedingTitle(
      precedingSucceedingTitleId1, precedingSucceedingTitleId2);
  ...
  private JsonObject getRecordById(JsonArray collection, String id) {
    return collection.stream()
      ...
      .filter(request -> Strings.CS.equals(request.getString("id"), id))
      .findFirst()
      .orElse(null);
  }
