...
public class HoldingsApiTest extends ApiTests {
  ...
  @Test
  public void canUpdateAnExistingHoldings() {
  ...
  @Test
  public void canSuppressFromDiscoveryOnUpdateForMarcRecord() {
  ...
  @Test
  public void cannotSuppressFromDiscoveryForSourceOnUpdateForFolioRecord() {
    var instanceId = instancesClient.create(InstanceRequestFixture.smallAngryPlanet()).getId();
  ...
  @Test
  public void cannotSuppressFromDiscoveryForSourceOnUpdateIfThatDoesNotExist() {
    var instanceId = instancesClient.create(InstanceRequestFixture.smallAngryPlanet()).getId();
    var newHoldings = holdingsStorageClient.create(new HoldingRequestBuilder()
        .forInstance(instanceId)
        .withMarcSource())
  ...
  @Test
  public void cannotUpdateAnHoldingsThatDoesNotExist() {
    UUID instanceId = instancesClient.create(InstanceRequestFixture.smallAngryPlanet()).getId();
  ...
  @Test
  public void canUpdateAnExistingMARCHoldingsIfNoChanges() {
    UUID instanceId = instancesClient.create(InstanceRequestFixture.smallAngryPlanet()).getId();
    JsonObject newHoldings = holdingsStorageClient.create(new HoldingRequestBuilder()
  ...
  @Test
  public void canNotUpdateAnExistingMARCHoldingsIfBlockedFieldsAreChanged() {
    UUID instanceId = instancesClient.create(InstanceRequestFixture.smallAngryPlanet()).getId();
    JsonObject newHoldings = holdingsStorageClient.create(new HoldingRequestBuilder()
      .forInstance(instanceId).withMarcSource()).getJson();
