...
class RestrictedTargetItemStatusValidatorTest {
  ...
  private final RestrictedTargetItemStatusValidator validator = new RestrictedTargetItemStatusValidator();
  ...
  void itemCanBeMarkedAsRestrictedWhenInAcceptableSourceStatus(String sourceStatus) {
  ...
  void itemCannotBeMarkedAsRestrictedWhenNotInAcceptableSourceStatus(String sourceStatus) {
    final var item = new Item(null, null, null, new Status(ItemStatusName.forName(sourceStatus)), null, null, null);
    final var validationFuture = validator.refuseItemWhenNotInAcceptableSourceStatus(item);
