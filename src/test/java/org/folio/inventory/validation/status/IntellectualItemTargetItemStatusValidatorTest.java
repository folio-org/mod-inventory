...
class IntellectualItemTargetItemStatusValidatorTest {

  private final IntellectualItemTargetItemStatusValidator validator = new IntellectualItemTargetItemStatusValidator();
  ...
  void itemCanBeMarkedAsIntellectualItemWhenInAcceptableSourceStatus(String sourceStatus) {
  ...
  void itemCannotBeMarkedAsAsIntellectualItemWhenNotInAcceptableSourceStatus(String sourceStatus) {
    final var item = new Item(null, null, null, new Status(ItemStatusName.forName(sourceStatus)), null, null, null);
    final var validationFuture = validator.refuseItemWhenNotInAcceptableSourceStatus(item);
