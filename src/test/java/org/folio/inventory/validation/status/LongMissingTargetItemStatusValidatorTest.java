...
class LongMissingTargetItemStatusValidatorTest {

  private final LongMissingTargetItemStatusValidator validator = new LongMissingTargetItemStatusValidator();
  ...
  void itemCanBeMarkedAsLongMissingWhenInAcceptableSourceStatus(String sourceStatus) {
  ...
  void itemCannotBeMarkedAsLongMissingWhenNotInAcceptableSourceStatus(String sourceStatus) {
    final var item = new Item(null, null, null, new Status(ItemStatusName.forName(sourceStatus)), null, null, null);
    final var validationFuture = validator.refuseItemWhenNotInAcceptableSourceStatus(item);
