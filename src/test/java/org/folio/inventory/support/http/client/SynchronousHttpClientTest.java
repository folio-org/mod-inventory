...
public class SynchronousHttpClientTest {
  ...
  public SynchronousHttpClientTest() throws MalformedURLException {
  }
  ...
  public void canGetJson() {
    ...
    var response = client.get(fakeWebServer.url("/record"));
  ...
  public void canPutWithJson() {
    ...
    var response = client.put(fakeWebServer.url("/record/12345"), dummyJsonRequestBody());
  ...
  private SynchronousHttpClient createClient() {
    return new SynchronousHttpClient(okapiUrl, tenantId, token, userId, requestId, error -> {});
  }
