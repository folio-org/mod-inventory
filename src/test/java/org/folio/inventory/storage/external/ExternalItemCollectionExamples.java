...
public class ExternalItemCollectionExamples {
  ...
  public void anItemCanBeAdded()
    ...
    assertThat(smallAngry.getStatus().getName().value(), is("Available"));
    ...
    assertThat(nod.getStatus().getName().value(), is("Available"));
    ...
    assertThat(uprooted.getStatus().getName().value(), is("Available"));
  ...
  public void anItemCanBeUpdated()
    ...
    assertThat(updated.getStatus().getName().value(), is("Checked out"));
  }
  ...
  public void anItemCanBeFoundById()
    ...
    assertThat(foundItem.getStatus().getName().value(), is("Available"));
    ...
    assertThat(otherFoundItem.getStatus().getName().value(), is("Available"));
