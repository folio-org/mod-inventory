...
public class ItemPreloaderTest {
    ...
    @InjectMocks
    private final ItemPreloader preloader = new ItemPreloader(ordersPreloaderHelper);
    ...
    public void shouldPreloadByPOL() {
        ...
        Assertions.assertThat(loadQuery.getCql())
                .isEqualTo(String.format("(holdingsRecords.id == \"%s\" OR holdingsRecords.id == \"%s\")",
                        holdingsIdsMock.get(0), holdingsIdsMock.get(1)));
    }
                        ...
                        .withContent(new MatchProfile()
                                ...
                                .withMatchDetails(singletonList(new MatchDetail()
                                        ...
                                        .withExistingMatchExpression(new MatchExpression()
                                                .withDataValueType(VALUE_FROM_RECORD)
                                                .withFields(singletonList(
                                                        new Field().withLabel("field").withValue("item.purchaseOrderLineNumber"))
                                                ))))));
    }
}
