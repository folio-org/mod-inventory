...
public class InstancesResponse {
  ...
  public boolean hasRecords() {
    return !success.result().records().isEmpty();
  }
  ...
  public InstancesResponse setParentInstanceMap(Map<String, List<InstanceRelationshipToParent>> parentInstanceMap) {
  ...
  public InstancesResponse setChildInstanceMap(Map<String, List<InstanceRelationshipToChild>> childInstanceMap) {
  ...
  public InstancesResponse setBoundWithInstanceIds(List<String> instanceIds) {
    ...
    for (Instance instance : success.result().records()) {
