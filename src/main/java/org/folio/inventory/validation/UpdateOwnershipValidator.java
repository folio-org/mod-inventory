...
public final class UpdateOwnershipValidator {
  ...
  public static Optional<ValidationError> updateOwnershipHasRequiredFields(String sourceTenant,
                                                                           JsonObject updateOwnershipRequest,
                                                                           Class<?> updateOwnershipClass) {
    ...
    if (sourceTenant.equals(targetTenantId)) {
      return Optional.of(
        new ValidationError("targetTenantId field cannot be equal to source tenant id", TARGET_TENANT_ID,
          targetTenantId));
    }
