...
public class DataImportKafkaHandler implements AsyncRecordHandler<String, String> {
  ...
  private void registerDataImportProcessingHandlers(Storage storage, HttpClient client) {
    ...
    EventManager.registerEventHandler(new CreateMarcHoldingsEventHandler(storage, mappingMetadataCache, new HoldingsIdStorageService(new EntityIdStorageDaoImpl(new PostgresClientFactory(vertx))),new CollectionStorageService()));
