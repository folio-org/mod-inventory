...
import org.folio.inventory.dataimport.handlers.actions.CreateMarcAuthoritiesEventHandler;
...
public class DataImportKafkaHandler implements AsyncRecordHandler<String, String> {
  ...
  private void registerDataImportProcessingHandlers(Storage storage, HttpClient client) {
    ...
    EventManager.registerEventHandler(new CreateMarcAuthoritiesEventHandler(storage, mappingMetadataCache));
